...
type FormState = { name: string; url: string; healthRoute: string; description: string; tags: string; enabled: boolean };
const blank: FormState = { name: "", url: "", healthRoute: "", description: "", tags: "", enabled: true };
...
export default function ServersPage() {
  ...
  function openEdit(server: ServerDto) { setEditing(server); setForm({ name: server.name, url: server.url, healthRoute: server.healthRoute ?? "", description: server.description ?? "", tags: server.tags.join(", "), enabled: server.enabled }); setModalOpen(true); }
