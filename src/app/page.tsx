...
function DashboardPageContent() {
  ...
  return <main className="space-y-3">
    ...
    <section className="grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-3">{filteredServers.map((server) => {
