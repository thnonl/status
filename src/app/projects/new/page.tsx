...
export default function NewProjectPage() {
  ...
  if (done) return <main className="space-y-3"><p className="text-lg text-emerald-300">Project “{done.name}” created.</p><Link href="/" className="text-cyan-300">Go to Dashboard</Link></main>;
