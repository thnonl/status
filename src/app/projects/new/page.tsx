    ...
    return (
      <main className="page-shell mx-auto max-w-xl">
        <div className="rounded-xl border border-emerald-400/20 bg-emerald-400/10 p-6 text-center">
          ...
          <Link href={`/?project=${done._id}`} className="ui-btn ui-btn-primary mt-6">
            Go to Dashboard
          </Link>
        </div>
      </main>
    ...
    <main className="page-shell mx-auto max-w-xl">
      ...
      <form onSubmit={submit} className="space-y-4 rounded-xl border border-white/10 bg-white/[0.04] p-6">
        ...
        <div className="flex justify-end gap-3 pt-2">
          <Link href="/projects" className="ui-btn ui-btn-secondary">Cancel</Link>
          <button className="ui-btn ui-btn-primary">Create</button>
        </div>
      </form>
    </main>
  );
